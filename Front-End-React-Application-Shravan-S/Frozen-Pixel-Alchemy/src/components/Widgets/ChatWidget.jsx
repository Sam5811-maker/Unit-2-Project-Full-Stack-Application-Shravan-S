...
/** * ChatWidget component for real-time chat functionality
 * Uses a custom hook for socket management and handles user messages
 * Integrates with a Spring Boot backend to call the Gemini API
 */
...
// - onToggle: function to toggle chat visibility
